...
private:
  ...
  IR2Vec::Vectors bb2Vec(llvm::BasicBlock &B,
                        llvm::SmallVector<llvm::Function *, 15> &funcStack);
  IR2Vec::Vectors func2Vec(llvm::Function &F,
                          llvm::SmallVector<llvm::Function *, 15> &funcStack);
  std::string res;
  llvm::SmallMapVector<const llvm::Function *, IR2Vec::Vectors, 16> funcVecMap;
...
public:
  ...
  llvm::SmallMapVector<const llvm::Function *, IR2Vec::Vectors, 16>
  getFuncVecMap() {
    return funcVecMap;
  }
